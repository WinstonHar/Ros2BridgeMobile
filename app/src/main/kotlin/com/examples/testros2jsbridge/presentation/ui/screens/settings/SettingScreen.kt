    ...
    Surface(
        ...
        LazyColumn(
            ...
            item {
                ...
                Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                    Checkbox(
                        checked = uiState.reconnectOnFailure,
                        onCheckedChange = { viewModel.setReconnectOnFailure(it) })
                ...
                Text(
                    text = "Last Connected IP: ${uiState.lastConnectedIp}",
                    style = MaterialTheme.typography.bodyMedium
                )
                Text(
                    text = "Last Connected Port: ${uiState.lastConnectedPort}",
                    style = MaterialTheme.typography.bodyMedium
                )
                Spacer(modifier = Modifier.height(16.dp))
